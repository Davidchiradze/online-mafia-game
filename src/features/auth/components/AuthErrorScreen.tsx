...
export default function AuthErrorScreen({ returnTo }: AuthErrorScreenProps) {
    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0a0a12] text-white">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 30%, rgba(220,38,38,0.25) 0%, transparent 55%), radial-gradient(ellipse at 50% 90%, rgba(147,51,234,0.12) 0%, transparent 50%)",
          }}
        />
        <div
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <motion.div
              ...
              className="mb-7 flex h-20 w-20 items-center justify-center rounded-2xl border border-red-500/30 bg-gradient-to-br from-red-500/25 to-red-900/40 shadow-[0_0_30px_rgba(220,38,38,0.35)]"
            >
