...
export function LobbySubscriptionModal() {
  ...
  return (
    <Modal open={open} onClose={markSeen} showClose={false} size="lg">
      ...
      <div className="relative -mx-6 -mb-6 -mt-12 overflow-hidden rounded-2xl border border-white/5 bg-black/70 p-8 backdrop-blur-2xl sm:p-10">
        ...
        <button
          onClick={markSeen}
          aria-label="close"
          className="absolute right-4 top-4 z-10 flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg text-gray-500 transition-all hover:bg-white/10 hover:text-white"
        >
          <X className="h-4 w-4" />
        </button>
