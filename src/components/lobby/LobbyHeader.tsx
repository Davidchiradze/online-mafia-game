...
export default function LobbyHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/50 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-3 px-4 py-2 rounded-xl bg-white/10 border border-white/10 hover:border-white/20 transition"
          >
            {/* Avatar */}
