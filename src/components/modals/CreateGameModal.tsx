      ...
      <div className="space-y-5">
        ...
        {!isEdit && (
          <div className="space-y-1.5">
            ...
            >
              {GAME_TYPES.filter(
                // sports_mafia is now creatable (Phase 5) — it ships UNRATED
                // (absent from RATING_CONFIG → ELO skipped). city_mafia stays
                // hidden until it has a ruleset. See docs/sports-mafia.md.
                (gt) => gt !== "city_mafia",
              ).map((gt) => (
