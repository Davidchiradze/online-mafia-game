  ...
  ({ label, error, isPassword = false, id, type, className = "", ...props }, ref) => {
    ...
    return (
      <div className="space-y-1.5">
        <label htmlFor={id} className="block text-sm font-medium text-gray-400 font-sans">
          {label}
        </label>
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-3 ${isPassword ? "pr-12" : ""} rounded-xl bg-white/[0.05] border ${
              error ? "border-red-500/50 focus:border-red-500" : "border-white/[0.08] focus:border-red-500/50"
