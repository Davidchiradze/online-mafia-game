...
- **`/docs/variants/japanese/rules.md`** — Mafia rules, phases, role visibility (Japanese variant)
- **`/docs/variants/japanese/win-conditions.md`** — Auto win-detection rules
- **`/docs/engine/variant-architecture.md`** — Multi-variant architecture (`GameDefinition` registry, shared-core vs per-variant split, refactor plan)
- **`/docs/variants/sports.md`** — Sports Mafia ruleset spec (10 players, 2 factions) as a diff from Japanese
